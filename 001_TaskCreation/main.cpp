...
int main() {
  prvInitialiseHeap();
  xTaskCreate(vBlueLEDControllerTask, "Blue LED controller", 100, // stack size
          nullptr, 1, nullptr);
  xTaskCreate(vRedLEDControllerTask, "Red LED controller", 100, // stack size
          nullptr, 1, nullptr);
  xTaskCreate(vGreenLEDControllerTask, "Green LED controller", 100, // stack size
          nullptr, 1, nullptr);
